...
if(currentZip && currentZip.length === 5 && parseInt(currentZip)) {
    ...
    .then(function(response) {
        ...
        //Advice Conditionals Object
            ...
            else if (currentTemp > 90 && weatherStatus === "Rain" || weatherStatus === "Thunderstorm") {
            ...
            else if (currentTemp <= 90 && currentTemp > 50 && weatherStatus === "Rain" || weatherStatus === "Thunderstorm") {
            ...
            else if (currentTemp <= 50 && weatherStatus === "Rain" || weatherStatus === "Thunderstorm") {
